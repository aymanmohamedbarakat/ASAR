  ...
  const socialLinks = [
    {
      ...
      url: "https://www.facebook.com/share/1FePcFqSsW/",
      label: "Facebook",
    },
    {
      icon: <PiTiktokLogoThin size={20} />,
      url: "https://www.tiktok.com/@athar_magazine?_t=ZS-8vQf1TuHXQW&_r=1",
      label: "Twitter",
    },
    {
      icon: <Instagram size={20} />,
      url: "https://www.instagram.com/athar20_25?igsh=aXJtejRjcjd4bGNx&utm_source=qr",
      label: "Instagram",
    },
  ];
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div className="flex flex-col items-start">
            ...
            <p className="text-gray-300 text-sm mb-4">
              بوابة إخبارية شاملة تقدم أحدث الأخبار والتقارير والتحليلات في
              مختلف المجالات السياحة و الآثار و التاريخ.
            </p>
        ...
        <div className="border-t border-gray-700 pt-4 text-center">
          <p className="text-gray-400 text-xs">
            جميع الحقوق محفوظة © {new Date().getFullYear()} | تم التطوير بواسطة
            فريقنا المتميز
          </p>
        </div>
      </div>
