        ...
        <div className="relative rounded-lg overflow-hidden mb-8 h-64">
          ...
          <div className="relative z-10 h-full flex flex-col justify-center p-8 text-right">
            ...
            <p className="text-green-100 max-w-xl">
              استكشف أحدث المقالات والتحليلات في مختلف المجالات الثقافية
              والتاريخية
            </p>
          </div>
        </div>
        ...
        {filteredArticles.length === 0 && (
          <div className="bg-white rounded-lg shadow-md p-10 text-center">
            ...
            <p className="text-gray-500 mb-6">
              لم يتم العثور على مقالات في هذه الفئة حالياً، يرجى تجربة فئة أخرى
              أو البحث عن محتوى مختلف
            </p>
            <button
              onClick={() => {
